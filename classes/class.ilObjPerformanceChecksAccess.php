...
* @version $Id$
*/
class ilObjPerformanceChecksAccess extends ilObjectPluginAccess
{
	...
	*/
	function _checkAccess($a_cmd, $a_permission, $a_ref_id, $a_obj_id, $a_user_id = "")
	{
		...
		{
			case "read":
				if (!ilObjPerformanceChecksAccess::checkOnline($a_obj_id) &&
	...
	*/
	static function checkOnline($a_id)
	{
		...
		$set = $ilDB->query("SELECT is_online FROM rep_robj_xpc0_data ".
